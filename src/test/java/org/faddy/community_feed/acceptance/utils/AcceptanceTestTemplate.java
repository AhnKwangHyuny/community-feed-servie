...
import static org.faddy.community_feed.acceptance.post.UserAcceptanceSteps.followUser;
...
public class AcceptanceTestTemplate {
    ...
    protected String getEmailToken(String email) {return dataLoader.getEmailToken(email);};
    ...
    protected String login(String email) {
        return requestLoginGetToken(new LoginRequestDto(email, "password", "test-token"));
    }
