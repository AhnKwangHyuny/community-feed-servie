        ...
        if (count != null && count == 0) {
            ...
            jdbcTemplate.execute(
                "CREATE PROCEDURE generate_post_data(IN total_records INT)\n" +
                    ...
                    "                WHEN RAND() < 0.5 THEN 'ONLY_FOLLOWER'\n" +
                    "                ELSE 'PRIVATE'\n" +
                    "            END,\n" +
                    "            random_user_id\n" +
                    "        );\n" +
                    ...
                    "            \n" +
                    "            -- 리소스 폴더에 있는 5개의 테스트 이미지 중 하나 선택\n" +
                    ...
                    "                WHEN 1 THEN 'KakaoTalk_Photo_2025-04-28-22-23-33 001.jpeg'\n" +
                    "                WHEN 2 THEN 'KakaoTalk_Photo_2025-04-28-22-23-34 002.jpeg'\n" +
                    "                WHEN 3 THEN 'KakaoTalk_Photo_2025-04-28-22-23-34 003.jpeg'\n" +
                    "                WHEN 4 THEN 'KakaoTalk_Photo_2025-04-28-22-23-34 004.jpeg'\n" +
                    "                ELSE 'test_default_image.png'\n" +
                    "            END;\n" +
                    "            \n" +
                    "            -- community_image 테이블에 이미지 데이터 삽입\n" +
                    ...
                    "        END WHILE;\n" +
                    "        \n" +
                    "        -- 100개 단위로 커밋 (빠른 처리를 위해 배치 크기 조정)\n" +
                    "        IF i % 100 = 0 THEN\n" +
                    "            COMMIT;\n" +
                    "            START TRANSACTION;\n" +
