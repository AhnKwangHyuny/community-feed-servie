...
public class QCommentEntity extends EntityPathBase<CommentEntity> {
    ...
    public final org.faddy.User.application.repo.entity.QUserEntity author;
    ...
    public QCommentEntity(Class<? extends CommentEntity> type, PathMetadata metadata, PathInits inits) {
        ...
        this.author = inits.isInitialized("author") ? new org.faddy.User.application.repo.entity.QUserEntity(forProperty("author")) : null;
