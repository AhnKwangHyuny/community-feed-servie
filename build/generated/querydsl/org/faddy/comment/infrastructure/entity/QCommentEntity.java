...
public class QCommentEntity extends EntityPathBase<CommentEntity> {
    ...
    private static final long serialVersionUID = -538938759L;
    ...
    public final org.faddy.User.infrastructure.repo.entity.QUserEntity author;
    ...
    public final org.faddy.post.application.repo.entity.QPostEntity post;
    ...
    public QCommentEntity(Class<? extends CommentEntity> type, PathMetadata metadata, PathInits inits) {
        ...
        this.author = inits.isInitialized("author") ? new org.faddy.User.infrastructure.repo.entity.QUserEntity(forProperty("author")) : null;
        this.post = inits.isInitialized("post") ? new org.faddy.post.application.repo.entity.QPostEntity(forProperty("post"), inits.get("post")) : null;
    }
